...
# member_info = data[username.lower()]

# if member_info is None:
#     print("User not found.")
# else:

#     weight_kg = member_info['weight']
#     height_cm = member_info['height']
#     age_years = member_info['age']
...
#         calorie_result = bmr * activity_level  # Calculate calories based on BMR and activity level
